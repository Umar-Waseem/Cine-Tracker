...
class _WatchedMoviesListViewScreenState
  ...
  @override
  void initState() {
    filteredMovies = widget.watchedMoviesData.watchedMovies;
    super.initState();
  }
                ...
                setState(
                  () {
                    switch (this.value) {
                      case "By Title":
                        filteredMovies =
                            widget.watchedMoviesData.searchMoviesByTitle(value);
                        break;
                      case 'By Year':
                        filteredMovies =
                            widget.watchedMoviesData.searchMoviesByYear(value);
                        break;
                      case 'By Genre':
                        filteredMovies =
                            widget.watchedMoviesData.searchMoviesByGenre(value);
                        break;
                      case 'By Duration':
                        filteredMovies =
                            widget.watchedMoviesData.searchMoviesByRuntime(value);
                        break;
                      case 'By Rating':
                        filteredMovies =
                      ...
                      case 'By Cast':
                        filteredMovies =
                            widget.watchedMoviesData.searchMoviesByCast(value);
                        break;
                      default:
                        filteredMovies =
                            widget.watchedMoviesData.searchMoviesByTitle(value);
                  ...
                  child: Dismissible(
                    ...
                    onDismissed: (direction) {
                      ...
                      if (direction == DismissDirection.endToStart) {
                        widget.watchedMoviesData.removeMovie(filteredMovies[index]);
                      }
                    },
                    key: UniqueKey(),
                    child: Column(
                      children: [
                        InkWell(
                          ...
                          child: ListTile(
                            ...
                            subtitle: Text(filteredMovies[index].genre.toString()),
                            trailing: Row(
                              mainAxisSize: MainAxisSize.min,
                              children: [
                                IconButton(
                                  onPressed: () {
                                    widget.favMoviesData.toggleFavorite(filteredMovies[index]);
                                    // snackbar
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        backgroundColor: filteredMovies[index].isFav
                                            ? Colors.green
                                            : Colors.red,
                                ...
                                IconButton(
                                  onPressed: () {
                                    ...
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        backgroundColor: filteredMovies[index].isWatched
                                            ? Colors.green
                                            : Colors.red,
                                        behavior: SnackBarBehavior.floating,
                                        margin: const EdgeInsets.all(10),
                        ...
                        if (!filteredMovies[index].expand)
                          InkWell(
                            onTap: () {
                              widget.watchedMoviesData.toggleExpand(filteredMovies[index]);
                            },
